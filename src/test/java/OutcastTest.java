...
public class OutcastTest {
    ...
    public void outcast_nounsAreNull_throws(){
        ...
        WordNet wordNet = WordNetTestUtils.newWordNet(graph, new HashMap<>(), new HashMap<>());
    ...
    public void outcast_allNounsAreIdentical_returnsAnyNoun(){
        ...
        WordNet wordNet = WordNetTestUtils.newWordNet(graph, nounToVertices, vertexToNouns);
        Outcast outcast = new Outcast(wordNet);
