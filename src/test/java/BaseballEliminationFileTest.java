...
//    @Test
//    public void certificateOfElimination_teams12_allgames(){
//        baseball = new BaseballElimination(fileName("teams12-allgames.txt"));
//        assertThat(baseball.certificateOfElimination("Team0")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team1")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team2")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team3")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team4")).isNull();
//        assertThat(baseball.certificateOfElimination("Team5")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team6")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team7")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team8")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team9")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team10")).containsAnyIn(
//                ImmutableList.of("Team4, Team11")
//        );
//        assertThat(baseball.certificateOfElimination("Team11")).isNull();
//    }
//
//    @Test
//    public void certificateOfElimination_teams24() {
//        baseball = new BaseballElimination(fileName("teams24.txt"));
//        assertThat(baseball.certificateOfElimination("Team13")).containsExactly();
//    }
//
//    @Test
//    public void certificateOfElimination_teams32() {
//        baseball = new BaseballElimination(fileName("teams32.txt"));
//        assertThat(baseball.certificateOfElimination("Team25")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team29")).containsExactly();
//    }
//
//    @Test
//    public void certificateOfElimination_teams36() {
//        baseball = new BaseballElimination(fileName("teams36.txt"));
//        assertThat(baseball.certificateOfElimination("Team21")).containsExactly();
//    }
//
//    @Test
//    public void certificateOfElimination_teams42() {
//        baseball = new BaseballElimination(fileName("teams42.txt"));
//        assertThat(baseball.certificateOfElimination("Team6")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team15")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team25")).containsExactly();
//    }
//
//    @Test
//    public void certificateOfElimination_teams48() {
//        baseball = new BaseballElimination(fileName("teams48.txt"));
//        assertThat(baseball.certificateOfElimination("Team6")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team23")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team47")).containsExactly();
//    }
//
//    @Test
//    public void certificateOfElimination_teams54() {
//        baseball = new BaseballElimination(fileName("teams54.txt"));
//        assertThat(baseball.certificateOfElimination("Team3")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team29")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team37")).containsExactly();
//        assertThat(baseball.certificateOfElimination("Team50")).containsExactly();
//    }
}
