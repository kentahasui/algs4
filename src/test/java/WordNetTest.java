...
public class WordNetTest {
    ...
    public void ctor_gIsEmpty_throwsException_treeHasNoRoot(){
        ...
        new WordNet(g, new HashMap<>(), new HashMap<>());
    }
    ...
    public void isNoun_null_throws(){
        Digraph g = new Digraph(1);
        WordNet wordNet = new WordNet(g, new HashMap<>(), new HashMap<>());
        wordNet.isNoun(null);
    }
    ...
    public void isNoun_oneVertex(){
        ...
        vertexToNouns.put(0, Lists.newArrayList("a"));
        WordNet wordNet = new WordNet(g, nounToVertices, vertexToNouns);
    ...
    public void isNoun_multipleVertices_(){
        ...
        Map<Integer, List<String>> vertexToNouns = new HashMap<>();
        vertexToNouns.put(0, Lists.newArrayList("a"));
        vertexToNouns.put(1, Lists.newArrayList("b"));
        WordNet wordNet = new WordNet(g, nounToVertices, vertexToNouns);
        assertThat(wordNet.isNoun("a")).isTrue();
    ...
    public void isNoun_multipleVerticesInSameSynset(){
        ...
        Map<Integer, List<String>> vertexToNouns = new HashMap<>();
        vertexToNouns.put(0, Lists.newArrayList("a"));
        vertexToNouns.put(1, Lists.newArrayList("a"));
        vertexToNouns.put(2, Lists.newArrayList("a"));
        WordNet wordNet = new WordNet(g, nounToVertices, vertexToNouns);
        assertThat(wordNet.isNoun("a")).isTrue();
    }
    ...
    public void distance_aAndBAreInSameSynset_returnsZero() {
        ...
        vertexToNouns.put(0, Lists.newArrayList("a", "b"));
    ...
    public void distance_bOnPathOfA_distanceBetweenAAndB(){
        ...
        vertexToNouns.put(2, Lists.newArrayList("c"));
        // 3,d
        nounToVertices.put("d", Lists.newArrayList(3));
        vertexToNouns.put(3, Lists.newArrayList("d"));
        // 4,e
        nounToVertices.put("e", Lists.newArrayList(4));
        vertexToNouns.put(4, Lists.newArrayList("e"));
        // 5,f
        nounToVertices.put("f", Lists.newArrayList(5));
        vertexToNouns.put(5, Lists.newArrayList("f"));
    ...
    public void distance_synsetsHaveDifferentClosestAncestors_choosesShortestPath(){
        ...
        vertexToNouns.put(1, Lists.newArrayList("b"));
        vertexToNouns.put(3, Lists.newArrayList("b"));
        nounToVertices.put("c", Lists.newArrayList(4));
        vertexToNouns.put(4, Lists.newArrayList("c"));
    ...
    public void sap_aAndBAreInSameSynset_returnsAnyInSynset() {
        ...
        WordNet wordNet = new WordNet(g, nounToVertices, vertexToNouns);
        assertThat(wordNet.sap("a", "b")).isAnyOf("a", "b");
    }
